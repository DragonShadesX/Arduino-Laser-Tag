 ...
 * Modified by: Greg Tighe (dragonshadesx)
 * For tagger used by: Greg Tighe (dragonshadesx)
 * 
 * Hello!
 * 
 ...
 *  - tagging (semi-auto, locked at 5 per second)
 *  - being tagged
 *  - audio feedback
 *  - clip-style reloading with LED ammo counter
 *  - free-for-all game mode ONLY
 * 
 * Tagger hardware requirements:
 *  - Arduino Teensy 3.1 or 3.2
 *  - Trigger (push-button)
 *  - IR LEDs (LED, potentially powered through a relay and additional batteries)
 *  - Ammo LED bar graph
 *  - Health LED bar graph
 *  - IR Receiver (38KHz)
 *  - Audio Shield
 * 
